...
public class BankingRepository {
	...
	public BankingRepository() {
		map.put(100, new Account(100, "김무신", 1234, 500000));
		map.put(200, new Account(200, "강기우", 1234, 1500000));
		map.put(300, new Account(300, "이화백", 1234, 3500000));
		map.put(400, new Account(400, "강혜원", 1234, 5500000));
		map.put(500, new Account(500, "안창호", 1234, 9500000));
	}
